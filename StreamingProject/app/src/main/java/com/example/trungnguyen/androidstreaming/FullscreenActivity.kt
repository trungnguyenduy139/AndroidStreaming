...
class FullscreenActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mWebView5 = findViewById<WebView>(R.id.webview5)

        mWebView5.webViewClient = MyWebViewClient(ip)
        mWebView5.settings.loadsImagesAutomatically = true
        mWebView5.settings.javaScriptEnabled = true
        mWebView5.scrollBarStyle = View.SCROLLBARS_INSIDE_OVERLAY
        ...
        findViewById<View>(R.id.dummy_button).setOnClickListener {
